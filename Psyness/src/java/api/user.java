...
public class user extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            // Convertir el parámetro de consulta a un número entero
            int userId = Integer.parseInt(userIdParam);
            
            // Obtener los datos del usuario utilizando el método getUserByInterUsersNum
            InterUsersService userService = new InterUsersService();
            InterUsers user = userService.getUserByInterUsersNum(userId);
            ...
            // Si el parámetro de consulta no es un número válido, devuelve un error
            response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
            return;
        }
    }
