...
<%
        ...
        response.sendRedirect("../zSocial/profile-new.jsp?id="+rooot);
              }else{response.sendRedirect("../zSocial/profile-new.jsp?id="+rooot);}}
        ...
        boolean successs = favorite.unfollowFav(fav);
        response.sendRedirect("../zSocial/favs.jsp?rufless=on&&favs="+rooot);}else{response.sendRedirect("../zSocial/favs.jsp?rufless=on&&favs="+rooot);}}
            }
