...
<div class="main_content">
            <div class="mcontainer">
                ...
                <div class="flex justify-between relative md:mb-4 mb-3">
                    <div class="flex-1">
                        <h2 class="text-2xl font-semibold"> Videos Hope Core </h2>
                    ...
                    <a href="#create-post-modal" uk-toggle="" class="flex items-center justify-center h-9 lg:px-5 px-2 rounded-md bg-blue-600 text-white space-x-1.5 absolute right-0">
                        ...
                        <span class="md:block hidden"> Subir </span>
                    </a> 
                </div>
                ...
                <div class="md:mb-4 mb-3">
                    <h2 class="text-2xl font-semibold"> Tus Videos </h2>
                ...
                <div class="divide-y">
                    ...
                    <div class="flex md:space-x-6 space-x-4 md:py-5 py-3 relative">
                        <a href="vervideo.jsp" class="md:w-64 md:h-40 w-36 h-24 overflow-hidden rounded-lg relative shadow-sm"> 
                             <img src="../assets/images/hopecore2.png" alt="" class="w-full h-full absolute inset-0 object-cover">
                        ...
                        <div class="flex-1 space-y-2"> 
                           ...
                           <div class="flex items-center justify-between">
                            ...
                            <div class="absolute top-1 right-0 md:inline hidden">
                                ...
                                <div class="bg-white w-56 shadow-md mx-auto p-2 mt-12 rounded-md text-gray-500 hidden text-base border border-gray-100 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700 uk-drop uk-drop-top-right" uk-drop="mode: hover;pos: top-right" style="left: -176.25px; top: -276.75px;">
