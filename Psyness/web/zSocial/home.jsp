<%-- 
    Document   : feed-prueba
    Created on : 28 abr. 2024, 22:46:09
    Author     : makak
--%>
        ...
        <!---------------------------------------------- MAIN CONTENT -------------------------------------------------------------------------->
                <div class="Main_content">
                    <div class="Main_container">  
                       ...
                       <div class="header_inicio_clinicass">
                           <div class="bg-white">
                               <nav class="items-center justify-between p-2 lg:px-12">    
                        ...
                        <!------------------- Perfil --------------------------->
                        <div class="section-publicaciones">
                            <div class="md:flex md:space-x-6 lg:mx-16">
                                <div class="space-y-5 flex-shrink-0 md:w-full">
                                       <!-- Crear publiccion  -->
                                       <div class="lg:mx-0 p-4" uk-toggle="target: #create-post-modal" id="card_posting">
                        ...
                        <div class="section-info-profile">
                            ...
                            <div class=" wave_feed">
                                ...
                                <div class="w-full space-y-6">
                                        ...
                                        <div class=" lg:mx-0 p-9 overflow-auto" id="contenedor_side_right">
