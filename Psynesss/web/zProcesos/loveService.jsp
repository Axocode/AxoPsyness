...
<html>
    ...
    <body>
        ...
        pubInt = pubInt + 1;
        response.sendRedirect("../zSocial/feed-new.jsp#"+pubInt);}}else {pubInt = pubInt + 1;response.sendRedirect("../zSocial/feed-new.jsp#"+pubInt);}}
        ...
        response.sendRedirect("../zSocial/profile-new.jsp?id="+pre);
            }}else response.sendRedirect("../zSocial/profile-new.jsp?id="+pre);}
        ...
        response.sendRedirect("../zSocial/favs.jsp?rufless=on&&favs="+request.getParameter("u"));
              }}else{response.sendRedirect("../zSocial/favs.jsp?rufless=on&&favs="+request.getParameter("u"));}}
        ...
        response.sendRedirect("../zSocial/profile-new.jsp?id="+rooot);
        ...
        response.sendRedirect("../zSocial/favs.jsp?rufless=on&&favs="+request.getParameter("u"));}}else{response.sendRedirect("../zSocial/favs.jsp?rufless=on&&favs="+request.getParameter("u"));}}
            }
